...
const billingPlanTitle = 'RPG AUVP';
const billingPlanAttributes = {
  description: billingPlanTitle,
  type: 'INFINITE',
  merchant_preferences: {
    auto_bill_amount: 'yes',
    cancel_url: live ? 'https://rpg.auvp.com.br' : 'http://localhost:3000',
    return_url: `${live ? 'https://rpg.auvp.com.br' : 'http://localhost:3000'}/paypal/subscribe/success`,
  },
  payment_definitions: [{
    type: 'REGULAR',
    frequency: 'MONTH',
...
switch (OP) {
  ...
  case 'update':
    const updatePayload = {
      ...
      value: {
        cancel_url: 'https://rpg.auvp.com.br',
      },
    };
